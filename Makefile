.PHONY: migrate test api web scrape-federal scrape-al scrape-ak scrape-ny scrape-co scrape-de scrape-fl scrape-id scrape-ks scrape-ma scrape-md scrape-mn scrape-nc scrape-nd scrape-ne scrape-oh scrape-or scrape-ri scrape-sd scrape-ut scrape-wi scrape-wy reset-db
...
scrape-al:
	cd packages/scrapers && .venv/bin/python -m axiom_bills.cli scrape --jurisdiction us-al --limit 50
...
scrape-ma:
	cd packages/scrapers && .venv/bin/python -m axiom_bills.cli scrape --jurisdiction us-ma --limit 50
...
scrape-nc:
	cd packages/scrapers && .venv/bin/python -m axiom_bills.cli scrape --jurisdiction us-nc --limit 50
