.PHONY: migrate test api web scrape-federal scrape-ny scrape-co scrape-de scrape-fl scrape-id scrape-ks scrape-md scrape-mn scrape-oh scrape-or scrape-sd scrape-ut scrape-wi reset-db
