"""Louisiana bill kind classifier."""
...
TITLE_PATTERNS = compile_kind_patterns([
    (r"\bappropriat(?:e|ion|ions)|budget|capital outlay|fiscal year\b", BillKind.APPROPRIATIONS),
    (r"\bcommend(?:ing)?|honor(?:ing)?|recogniz(?:e|ing)|congratul", BillKind.CEREMONIAL),
