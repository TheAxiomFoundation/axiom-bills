...
TITLE_PATTERNS = compile_kind_patterns([
    (r"relating to: state finances and appropriations", BillKind.APPROPRIATIONS),
    (r"relating to: .*appropriations?", BillKind.APPROPRIATIONS),
    (r"congratulating|commending|honoring|recognizing|commemorating", BillKind.CEREMONIAL),
])
