"""Mississippi bill kind classifier."""
...
TITLE_PATTERNS = compile_kind_patterns([
    (r"\bappropriat(?:e|ion|ions)|budget|disbursement|state fiscal officer\b", BillKind.APPROPRIATIONS),
    (r"\bcommend(?:ing)?|honor(?:ing)?|recogniz(?:e|ing)|memorial", BillKind.CEREMONIAL),
