...
TITLE_PATTERNS = compile_kind_patterns([
    (r"\bappropriat(?:e|ion|ions)|budget|capital improvement|grant[- ]in[- ]aid\b", BillKind.APPROPRIATIONS),
    (r"\bcongratulat(?:e|ing)|commend(?:ing)?|honor(?:ing)?|recogniz(?:e|ing)|memorializ", BillKind.CEREMONIAL),
    (r"\brules of the (?:house|senate)|standing committee|recess|adjourn\b", BillKind.PROCEDURAL),
])
