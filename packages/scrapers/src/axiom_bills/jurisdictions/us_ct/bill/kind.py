"""Connecticut bill kind classifier."""
...
TITLE_PATTERNS = compile_kind_patterns([
    (r"\bappropriation|appropriations|budget|bond(?:s|ing)?\b", BillKind.APPROPRIATIONS),
    (r"\bcommemorat(?:e|ing)|congratul(?:ate|ating)|honor(?:ing)?|recogniz(?:e|ing)\b", BillKind.CEREMONIAL),
